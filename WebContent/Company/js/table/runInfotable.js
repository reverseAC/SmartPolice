...
var TableInit = function() {
		...
		
			{
				...
				function (value, row, index) {//赋予的参数
                    return [
                        ...
                        '<a class="btn2" type="button"  id="tablechakan"> 查看</a>',
                        
                        '<a class="btn2" type="button"> 删除</a>'
                    ].join('');
                }
			} 
			]
	...
	window.operateEvents={
			...
			"click #tablechakan":function(e,value,row,index){
				...
				$(this).attr("href","runInfoDeinfo.jsp?id="+m);
			},
	
			"click #tabledelete":function(e,value,row,index){
				var m=$(this).parent().parent().find("td").eq(1).text();
				
				$(this).attr("href","firmRemoveDevice.action?id="+m);
			}
	}
	// 得到查询的参数
