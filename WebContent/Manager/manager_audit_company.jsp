    	...
    	<!-- 需要添加的从这里开始 -->
    		<div class="operation">
        		...
        		<!-- 	<li><a href="#"><b></b>删除</a></li> -->
      			 ...
      			 <li><a href="javascript:window.location.href='BatchHandleaCompanyuser.action?at=pass&ids='+chk();">
      				<b></b>批量通过</a></li>
        		
        	 		<li><a href="javascript:window.location.href='BatchHandleaCompanyuser.action?at=refused&ids='+chk();"><b></b>批量拒绝</a></li>
        		...
        		<!-- 表格 -->
        		<!--    <button onclick="chk()">点击调用demo函数</button>		 -->
        		<div class="form" id="form">
        			...
        			<tbody>
					<s:iterator value="#session.auditCompany" id="pdl" > 
								<tr>
								...
								<%-- 	<li><a href="ManagerRemoveCompanyUser.action?id=<s:property value="#pdl.USERID"/>">
									...
									<li><a href="manager_audit_company.all.jsp?id=<s:property value="#pdl.companyid"/>">
										<b 	class="form_icon_check"></b>查看</a></li> 
											<li><a href="ManagerPassCompany.action?id=<s:property value="#pdl.userid"/>">
											<b class="form_icon_mod"></b>通过</a></li> 
										<li><a href="ManagerRefusedCompany.action?id=<s:property value="#pdl.userid"/>">
