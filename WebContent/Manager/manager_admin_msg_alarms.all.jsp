...
<body>
<s:action name="All_msg_alarms" ></s:action>
<div class="main main_body">
	<div class="content index_content">
        	...
        	<div class="operation">
        		...
        		<!-- 详细信息 -->
        			<s:iterator value="#session.allalarmmsgInfo" id="api" > 
        		<ul class="detailed_list">
        			<li>
        				<i>序号：</i>
        			<div class="detailed_content">
						<s:property value="#api.alarmid"/>
						</div>
        			</li>
        			<li>
        				<i>报警设备：</i>
        			...
        			<div class="detailed_content">
        				...
        				<i>严重级别：</i>
        				<div class="detailed_content">
						<s:property value="#api.level"/>
						</div>
        			</li>
        			<li>
        				<i>URL：</i>
        				<div class="detailed_content">
						<s:property value="#api.url"/>
						</div>
        			</li>
        			<li>
        				<i></i>
