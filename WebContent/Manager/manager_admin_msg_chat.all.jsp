...
<body>
<s:action name="All_msg_chat" ></s:action>
<div class="main main_body">
	<div class="content index_content">
        	...
        	<div class="operation">
        		...
        		<!-- 详细信息 -->
        			<s:iterator value="#session.allchatmsgInfo" id="api" > 
        		<ul class="detailed_list">
        			<li>
        				<i>序号：</i>
        					<div class="detailed_content">
						<s:property value="#api.chatid"/>
						</div>
        			</li>
        			<li>
        				<i>发送者：</i>
        					<div class="detailed_content">
						<s:property value="#api.sendid"/>
						</div>
        			</li>
        			<li>
        				<i>接收者：</i>
        					<div class="detailed_content">
						<s:property value="#api.recvid"/>
						</div>
        			</li><li>
        				<i>查看时间：</i>
        					<div class="detailed_content">
						<s:property value="#api.sendtime"/>
						</div>
        			</li>
        			<li>
        				<i>信息：</i>
        					<div class="detailed_content">
						<s:property value="#api.msg"/>
						</div>
        			</li>
        			<li>
        				<i></i>
