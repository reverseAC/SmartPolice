    		...
    		<div class="operation ">
        		<ul class="operating">
					...
					<li><a href="#" onclick="printdiv('form');"><b></b>打印</a></li>
        			 ...
        			 <li><a href="javascript:window.location.href='batchHandlePredevice.action?at=pass&ids='+chk();">
      				<b></b>批量通过</a></li>
        			<li><a href="javascript:window.location.href='batchHandlePredevice.action?at=refused&ids='+chk();"><b></b>批量拒绝</a></li>
        		...
        		<div class="form" id="form">
        			<table id="blocks" class="table table-striped" style="margin-top:25px">
        				<tr>
        					...
        					<s:iterator value="#session.auditDevice" id="pdl" > 
								<tr>
								...
								<ul>
									...
									<li><a href="manager_audit_device.all.jsp?id=<s:property value="#pdl.auditid"/>">
										<b 	class="form_icon_check"></b>查看</a></li> 
											<li><a href="ManagerPassdevice.action?id=<s:property value="#pdl.auditid"/>">
											<b class="form_icon_mod"></b>通过</a></li> 
										<li><a href="ManagerRefuseddevice.action?id=<s:property value="#pdl.auditid"/>">
