...
<body>
<s:action name="UserDetail1" ></s:action>
<div class="main main_body">
	<div class="content index_content">
        	...
        	<div class="operation">
        		...
        		<!-- 详细信息 -->
        			<s:iterator value="#session.UserInfo" id="api" > 
        		<ul class="detailed_list">
        			<li>
        				<i>序号：</i>
        				<div class="detailed_content">
						<s:property value="#api.userid"/>
						</div>
        			</li>
        			<li>
        				<i>用户名：</i>
        			...
        			<div class="detailed_content">
        				...
        				<i>用户级别：</i>
        					<div class="detailed_content">
						<s:property value="#api.authority"/>
						</div>
        			</li><li>
        				<i>用户状态：</i>
        				<div class="detailed_content">
